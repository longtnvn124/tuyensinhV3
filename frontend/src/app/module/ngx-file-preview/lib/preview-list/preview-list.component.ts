import { ChangeDetectionStrategy , Component , ContentChild , ElementRef , EventEmitter , Input , Output , QueryList , TemplateRef , ViewChildren , ViewEncapsulation } from '@angular/core';
...
@Component( {
	...
	standalone      : true ,
	imports         : [ CommonModule , PreviewIconComponent , PreviewDirective , I18nPipe , FileSizePipe ] ,
	providers       : [ ThemeService , PreviewService ] ,
	templateUrl     : 'preview-list.component.html' ,
	styleUrls       : [ '../styles/_theme.scss' , 'preview-list.component.scss' ] ,
