...
export class PlyrComponent implements AfterViewInit , OnChanges , OnDestroy {
	...
	private events : Map<any , any> = new Map();
	...
	private initPlyr ( force = false ) : void {
	...
	private updatePlyrSource ( plyr : Plyr ) : void {
	...
	private ensureVideoElement () : void {
		const videoElement : HTMLVideoElement = this.hostElement.querySelector( 'video' );
