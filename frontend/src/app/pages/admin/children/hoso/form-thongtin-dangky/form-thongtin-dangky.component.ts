...
export class FormThongtinDangkyComponent implements OnInit {
    ...
    constructor() {
        this.formData = this.fb.group({
            ...
            noi_sinh: [null , Validators.required],
            dia_chi_tinh: [null, Validators.required],
            dia_chi_xa: [null, Validators.required],
            dia_chi_nha: ['', Validators.required],
            ...
            vb_chuyenmon_noicap: [''],
            vb_chuyenmon_sohieu: [''],
            nganh_dangky: ['' ,Validators.required],
            ctdt_id: [null],
            doituong: [''],
            type_diem: [null],
            diem_xettuyen: [null],
