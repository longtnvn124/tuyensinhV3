...
import { IctuProgressComponent } from '@theme/components/ictu-progress/ictu-progress.component';
...
export class NotificationService {
	...
	private readonly OBSERVE_SYSTEM_IS_ASYNCHRONOUS_IN_TIME : Subject<string> = new Subject<string>();
	
	private readonly REMEASURE_DEVICE_SCREEN : Subject<string> = new Subject<string>();
	
	private readonly OBSERVE_LOADING_ANIMATION : Subject<boolean> = new Subject<boolean>();
	
	private readonly OBSERVE_OPEN_DEVTOOL : BehaviorSubject<boolean> = new BehaviorSubject<boolean>( false );
	
	private readonly observerSignOut$ : Subject<string> = new Subject<string>();
	
	private readonly observerSessionExpired$ : Subject<string> = new Subject<string>();
	
	private readonly refreshTokenSubject$ : BehaviorSubject<string> = new BehaviorSubject<string>( '' );
	...
	startProgressAnimation( eventControl : ProgressAnimationControl , heading : string ) : Observable<void> {
		const dialogRef : MatDialogRef<IctuProgressComponent> = this.dialog.open( IctuProgressComponent , {
